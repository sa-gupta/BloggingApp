...
import com.cg.blogging.exception.WrongCredentialsException;
...
public class UserController {
	...
	/**
	 * To inject new user having blogger role into both user and blogger repository.
	 * 
	 * @param blogger
	 * @return User & Blogger
	 */
	...
	/**
	 * To request signin for an existing user. Check for password validation. To
