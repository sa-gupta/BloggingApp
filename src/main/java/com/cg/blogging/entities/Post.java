...
//	private Award awardsReceived;
	@JsonFormat(pattern = "dd-MMM-yyy", timezone = "Asia/Calcutta")
	...
	public Post(String title, Blogger createdBy, PostType content, Date createdDateTime, boolean notSafeForWork,
	...
	public Post(int postId,String title, Blogger createdBy, PostType content, Date createdDateTime, boolean notSafeForWork,
			boolean spoiler, boolean originalContent, String flair, Community community) {
		super();
		this.postId = postId;
		this.title = title;
