 ...
 * <h1>User Class</h1>
 * <p>
 * This class is for creating a user by using the following parameters.
...
public class User {
	...
	@NotBlank
	@Pattern(regexp = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,}$", message = "password must be 8 to 16 characters long and consist of at least :"
	...
	/**
	 * <p>
	 * User class constructor to create a user by passing these arguments.
	 * 
	 * @param password
	 * @param role
	 */
